...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text">Category Listing</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <?php
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><a href="edit_tufr_category.php?id=<?php echo $data['category_id']; ?>">Edit</a></td>
                                            <td><a href="turf_category.php?id=<?php echo $data['category_id']; ?>" onclick="return confirm('Do you want to delet this data')"> Delete</a></td>
                                        </tr>
                                    <?php
                                        $i++;
                                    }
